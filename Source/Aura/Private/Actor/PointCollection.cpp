...
TArray<USceneComponent*> APointCollection::GetGroundPoints(const FVector& Location, int32 NumPoints, float YawOverride)
{
	checkf(ImmutablePts.Num() >= NumPoints, TEXT("Attempt to Access ImmutablePoints out of bounds."));
